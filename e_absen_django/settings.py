"""
Django settings for e_absen_django project.
...
ALLOWED_HOSTS = ['eabsendjangobackend-production.up.railway.app', '127.0.0.1', 'localhost', 'X390', 'play.googleapis.com']
...
ROOT_URLCONF = 'e_absen_django.urls'
...
WSGI_APPLICATION = 'e_absen_django.wsgi.application'
...
#cors specific if flutter have a diffrent domain
